...
class TestBudgetWidget(unittest.TestCase):
    def setUp(self):
        ...
        # ВАЖНО: build_chart_tab() создаёt QWebEngineView и сразу передаёт его в layout.addWidget(self.chart_view)
    ...
    def test_delete_transaction(self):
        ...
        # Закрываем его через QTimer, который сработает уже во время открытого диалога, пока mouseClick ждёт завершения обработчика.
        def confirm_delete():
